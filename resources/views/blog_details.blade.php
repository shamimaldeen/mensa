        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-8">
                    <img src="images/blogger1.jpg" alt="blogger-name" class="img-fluid">
                </div><!-- end column -->
                <div class="col-lg pt-4 pt-lg-0">
                    <div class="blogger-text">
                        <h1 class="fw-semi-bold text-black-5">Mary Jane</h1>
                        <h5 class="text-black-5">Founder Web</h5>
                        <p class="text-black-5 mt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit,
