...
<html lang="en">
  ...
  <body>
     ...
     @else
        <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> Portfolio</a></div>
    <div class="sl-sideleft">
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('add.about') }}" class="nav-link">Add About</a></li>
          <li class="nav-item"><a href="{{ route('all.about') }}" class="nav-link">About</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{ route('add.resume') }}" class="nav-link">Add Resume</a></li>
              <li class="nav-item"><a href="{{ route('all.resume') }}" class="nav-link"> Resume</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
              <li class="nav-item"><a href="{{ route('settings')}}" class="nav-link">Site Setting</a></li>
        </ul>
